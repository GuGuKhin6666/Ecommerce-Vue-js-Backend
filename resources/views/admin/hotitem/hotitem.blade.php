...
<div class="row mt-4">
    <div class="col-4 ">
     <div class="border mt-5">
      <form action="{{route('create#hotitem')}}" class="p-4" method="POST" enctype="multipart/form-data">
      @csrf
          ...
          <table class="table table-hover text-nowrap text-center">
            ...
            <tbody>
             ...
             <tr>
              ...
              <td>{{$d->description}}</td>
              <td>
               <a href="{{route('edit#hotitem',$d->id)}}"> <button class="btn btn-sm bg-dark text-white"><i class="fas fa-edit"></i></button></a>
                <a href="{{route('delete#hotitem',$d->id)}}"><button class="btn btn-sm bg-danger text-white"><i class="fas fa-trash-alt"></i></button></a>
              </td>
            </tr>
             @endforeach
            </tbody>
