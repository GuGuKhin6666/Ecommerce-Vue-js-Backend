...
<div class="row mt-4">
    <div class="col-4 ">
     <div class="border mt-5">
      <form action="{{route('create#blogtagpost')}}" class="p-4" method="POST" enctype="multipart/form-data">
      @csrf
          ...
          <table class="table table-hover text-nowrap text-center">
            ...
            <tbody>
             ...
             <tr>
              ...
              <td>
               <a href="{{route('edit#blogtagpost',$item->id)}}"> <button class="btn btn-sm bg-dark text-white"><i class="fas fa-edit"></i></button></a>
                <a href="{{route('delete#blogtagpost',$item->id)}}"><button class="btn btn-sm bg-danger text-white"><i class="fas fa-trash-alt"></i></button></a>
              </td>
            </tr>
             @endforeach
            </tbody>
